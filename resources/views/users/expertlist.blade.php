...
<div class="row clearfix">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
                <h2>Expert List <small>Basic example without any additional modification classes</small> </h2>
            </div>
            <div class="body">
