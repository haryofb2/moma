...
<head>
    ...
    @if (Request::segment(3) === 'analytical' )
    ...
    @if (Request::segment(3) === 'new-post' or Request::segment(3) === 'new-event' or Request::segment(3) ===
    'new-course' or Request::segment(3) ===
    'new-job' or Request::segment(1) ===
    'setting')
    ...
    @if (Request::segment(2) === 'dragdrop' or Request::segment(3) === 'new-event' or Request::segment(3) ===
    'new-course' or Request::segment(3) === 'new-post' or Request::segment(3) === 'new-job' or Request::segment(1) ===
    'setting')
...
<body class="<?= $theme ?>">
    ...
    <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30"><img src="{{url('/')}}/assets/img/logo_mom.png" height="50" alt="MOMAcademy"></div>
            <p>Please wait...</p>
        </div>
    </div>
