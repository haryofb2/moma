...
@section('parentPageTitle', 'Article')
        ...
        <div class="card single_post">
            ...
            <div class="footer">
                ...
                <ul class="stats">
                    ...
                    <li><a href="javascript:void(0);" class="icon-eye">128</a></li>
                </ul>
            </div>
        </div>
        ...
        <!-- <div class="card">
            ...
            <div class="body widget">
                <ul class="list-unstyled instagram-plugin m-b-0">
                    <li><a href="javascript:void(0);"><img src="{{asset('assets/img/blog/05-img.jpg')}}"
                                alt="image description"></a></li>
                    <li><a href="javascript:void(0);"><img src="{{asset('assets/img/blog/06-img.jpg')}}"
                                alt="image description"></a></li>
                    <li><a href="javascript:void(0);"><img src="{{asset('assets/img/blog/07-img.jpg')}}"
                                alt="image description"></a></li>
                    <li><a href="javascript:void(0);"><img src="{{asset('assets/img/blog/08-img.jpg')}}"
                                alt="image description"></a></li>
                    <li><a href="javascript:void(0);"><img src="{{asset('assets/img/blog/09-img.jpg')}}"
                                alt="image description"></a></li>
                    <li><a href="javascript:void(0);"><img src="{{asset('assets/img/blog/10-img.jpg')}}"
                                alt="image description"></a></li>
                    <li><a href="javascript:void(0);"><img src="{{asset('assets/img/blog/11-img.jpg')}}"
                                alt="image description"></a></li>
                    <li><a href="javascript:void(0);"><img src="{{asset('assets/img/blog/12-img.jpg')}}"
                                alt="image description"></a></li>
                    <li><a href="javascript:void(0);"><img src="{{asset('assets/img/blog/13-img.jpg')}}"
                                alt="image description"></a></li>
                </ul>
            </div>
        </div> -->
